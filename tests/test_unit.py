...
class TestUnitClass:
    ...
    def test_unit_flat_writer_flat_row_header(self):
        ...
        """
        expected_output = 'test1 test2  test3   '
        actual_output = DFG_OBJ.generate_flat_header_row(['test1', 'test2', 'test3'], [6, 7, 8])
    ...
    def test_unit_csv_writer_csv_row_header(self):
        ...
        """
        expected_output = 'test1,test2,test3'
        actual_output = DFG_OBJ.generate_csv_header_row('test1,test2,test3')
    ...
    def test_unit_flat_writer_flat_row_output(self):
        ...
        """
        raw_expected_output = DFG_OBJ.generate_flat_body_row(['test', 'test', 'test'], [6, 7, 8])
    ...
    def test_unit_csv_writer_csv_row_output(self):
        ...
        """
        raw_expected_output = DFG_OBJ.generate_csv_body_row(['test', 'test', 'test'])
