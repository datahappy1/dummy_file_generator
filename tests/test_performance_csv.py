...
# assuming 1Mb csv file will get written under 30 seconds
# alter this referential value based on your HW resources
def test_integration_csv():
    filename = "tests", "test_run_result_performance_test_csv"
    filename = os.sep.join(filename)

    execution_start_time = datetime.now()

    main("test_csv", filename, 1048576, 'generated_files'+os.sep)
